...
$string['createurl'] = 'Create a Practice';
...
$string['externalurl'] = 'External Practice';
$string['framesize'] = 'Frame height';
$string['invalidstoredurl'] = 'Cannot display this resource, Practice is invalid.';
$string['chooseavariable'] = 'Choose a variable...';
$string['invalidurl'] = 'Entered Practice is invalid';
...
$string['page-mod-url-x'] = 'Any Practice module page';
...
$string['serverurl'] = 'Server Practice';
$string['url:addinstance'] = 'Add a new Practice resource';
$string['url:view'] = 'View Practice';
